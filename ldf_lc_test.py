...
net, time_steps, const_pv, const_load_heatpump, const_load_heatpump_Q ,df_household_prognosis, df_season_heatpump_prognosis, heatpump_scaling_factors_df, T_amb = gd.setup_grid_IAS_variance(season='winter')

# for t in time_steps:
#     electricity_price[t] = 100

results_variance = drcc.calculate_variance_propagation(time_steps, net)
